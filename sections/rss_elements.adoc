...
| at:delete-entry footnote:[cf: https://datatracker.ietf.org/doc/html/rfc6721[https://datatracker.ietf.org/doc/html/rfc6721]]| Element used for an item that has been
